...
const [authUser, setAuthUser] = useAuth();
  ...
  return (
    <>
      <div className={`max-w-screen-2xl continer mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 right-0 left-0 z-50 ${sticky ? "sticky-navbar shadow-md bg-base-200 dark:bg-slate-600 dark:text-white duration-300 transrition-all ease-in-out" : ""
        }`
      }>
        <div>
          <div className="navbar ">
            ...
            <div className="navbar-end space-x-3">
              ...
              <div className="hidden md:block">
                <label className=" px-3 py2 border rounded-md flex items-center gap-2">
...

              {
                ...
                <div className="">
                <a className="btn bg-green-700 text-white px-3 py-2 rounded-md hover:bg-green-800 duration-300 cursor-pointer" onClick={()=>
